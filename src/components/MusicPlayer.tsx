...
const MusicPlayer = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-spotify-medium-gray border-t border-spotify-light-gray">
      {/* Mobile Layout */}
        ...
        <div className="flex items-center justify-between p-4">
          ...
          <div className="flex items-center gap-3 flex-1 min-w-0">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-spotify-text-gray text-xs truncate">The Weeknd</p>
            </div>
          </div>
      ...
      {/* Desktop Layout */}
      <div className="hidden md:flex items-center px-4 h-20">
        {/* Currently Playing */}
